...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      options: {
        ...
        isUnique: async (slug, context) => {
          ...
          const query = `!defined(*[!(_id in [$draft, $published]) && slug.current == $slug && language == $language && _type == "fair"][0]._id)`
    ...
    defineField({
      ...
      title: "Venue",
      type: "string",
      description: "Location or venue of the fair",
    }),
    defineField({
      name: "artistsLine",
      title: "Artists Line",
    ...
    defineField({
      ...
      title: "Author Name",
      type: "string",
      description: "Nome dell'autore dell'articolo della fiera",
    }),
    defineField({
      name: "dateStart",
      title: "Start Date",
